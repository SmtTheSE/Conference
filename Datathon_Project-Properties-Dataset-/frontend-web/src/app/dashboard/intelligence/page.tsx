...
export default function MarketIntelligence() {
    ...
    const [loadingText, setLoadingText] = useState("Accessing real-world listing data...");

    useEffect(() => {
        if (!loading) return;
        const messages = [
            "Accessing real-world listing data...",
            "Normalizing regional currency...",
            "Executing transfer learning logic...",
            "Calculating distance to infrastructure...",
            "Executing cross-border benchmark analysis...",
            "Generating AI tactical insights..."
        ];
        let i = 0;
    ...
    const locationsForCountry = Array.isArray(locationMap[country]) ? locationMap[country] : [];
    const filteredLocations = locationsForCountry.filter(loc =>
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. Comps
            const allTargets = [
                { country: "Thailand", location: "Ladprao" },
                    ...
                    <div className="bg-white border-t-4 border-asean-yellow shadow-sm p-6 min-h-[400px] flex flex-col justify-center items-center text-center relative overflow-hidden">
                        ...
                        {loading && (
                            <div className="animate-pulse flex flex-col items-center">
                                ...
                                <div className="text-[10px] font-bold uppercase tracking-widest text-asean-navy">
                                    {loadingText}
                                </div>
                            </div>
                        )}
